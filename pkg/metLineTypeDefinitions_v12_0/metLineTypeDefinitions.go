...
type STAT_VCNT struct {
	...
	TOTAL_DIR            float64 `json:"total_dir,omitempty"`
	DIR_ME               float64 `json:"dir_me,omitempty"`
	DIR_ME_BCL           float64 `json:"dir_me_bcl,omitempty"`
	DIR_ME_BCU           float64 `json:"dir_me_bcu,omitempty"`
	DIR_MAE              float64 `json:"dir_mae,omitempty"`
	DIR_MAE_BCL          float64 `json:"dir_mae_bcl,omitempty"`
	DIR_MAE_BCU          float64 `json:"dir_mae_bcu,omitempty"`
	DIR_MSE              float64 `json:"dir_mse,omitempty"`
	DIR_MSE_BCL          float64 `json:"dir_mse_bcl,omitempty"`
	DIR_MSE_BCU          float64 `json:"dir_mse_bcu,omitempty"`
	DIR_RMSE             float64 `json:"dir_rmse,omitempty"`
	DIR_RMSE_BCL         float64 `json:"dir_rmse_bcl,omitempty"`
