...
func (s *TCST_TCDIAG) fill_TCST_TCDIAG_Header(fields []string, doc *map[string]interface{}) {
	...
	i++
	SetValueForField(doc, "TCST", "VERSION", i, dataLen, fields, 0)
	i++
	SetValueForField(doc, "TCST", "AMODEL", i, dataLen, fields, 1)
	i++
	SetValueForField(doc, "TCST", "BMODEL", i, dataLen, fields, 2)
	i++
	SetValueForField(doc, "TCST", "DESC", i, dataLen, fields, 3)
	i++
	SetValueForField(doc, "TCST", "STORM_ID", i, dataLen, fields, 4)
	i++
	SetValueForField(doc, "TCST", "BASIN", i, dataLen, fields, 5)
	i++
	SetValueForField(doc, "TCST", "CYCLONE", i, dataLen, fields, 6)
	i++
	SetValueForField(doc, "TCST", "STORM_NAME", i, dataLen, fields, 7)
	i++
	SetValueForField(doc, "TCST", "INIT", i, dataLen, fields, 8)
	i++
	SetValueForField(doc, "TCST", "LEAD", i, dataLen, fields, 9)
	i++
	SetValueForField(doc, "TCST", "VALID", i, dataLen, fields, 10)
	i++
	SetValueForField(doc, "TCST", "INIT_MASK", i, dataLen, fields, 11)
	i++
	SetValueForField(doc, "TCST", "VALID_MASK", i, dataLen, fields, 12)
	i++
	SetValueForField(doc, "TCST", "LINE_TYPE", i, dataLen, fields, 13)
}
...
func (s *STAT_DMAP) fill_STAT_DMAP_Header(fields []string, doc *map[string]interface{}) {
	...
	// fill the met fields leaving out "" and NA values
	i++
	SetValueForField(doc, "STAT", "VERSION", i, dataLen, fields, 0)
	i++
	SetValueForField(doc, "STAT", "MODEL", i, dataLen, fields, 1)
	i++
	SetValueForField(doc, "STAT", "DESC", i, dataLen, fields, 2)
	i++
	SetValueForField(doc, "STAT", "FCST_VALID_BEG", i, dataLen, fields, 4)
	i++
	SetValueForField(doc, "STAT", "FCST_VALID_END", i, dataLen, fields, 5)
	i++
	SetValueForField(doc, "STAT", "OBS_LEAD", i, dataLen, fields, 6)
	i++
	SetValueForField(doc, "STAT", "OBS_VALID_BEG", i, dataLen, fields, 7)
	i++
	SetValueForField(doc, "STAT", "OBS_VALID_END", i, dataLen, fields, 8)
	i++
	SetValueForField(doc, "STAT", "FCST_VAR", i, dataLen, fields, 9)
	i++
	SetValueForField(doc, "STAT", "FCST_UNITS", i, dataLen, fields, 10)
	i++
	SetValueForField(doc, "STAT", "FCST_LEV", i, dataLen, fields, 11)
	i++
	SetValueForField(doc, "STAT", "OBS_VAR", i, dataLen, fields, 12)
	i++
	SetValueForField(doc, "STAT", "OBS_UNITS", i, dataLen, fields, 13)
	i++
	SetValueForField(doc, "STAT", "OBS_LEV", i, dataLen, fields, 14)
	i++
	SetValueForField(doc, "STAT", "OBTYPE", i, dataLen, fields, 15)
	i++
	SetValueForField(doc, "STAT", "VX_MASK", i, dataLen, fields, 16)
	i++
	SetValueForField(doc, "STAT", "INTERP_MTHD", i, dataLen, fields, 17)
	i++
	SetValueForField(doc, "STAT", "INTERP_PNTS", i, dataLen, fields, 18)
	i++
	SetValueForField(doc, "STAT", "FCST_THRESH", i, dataLen, fields, 19)
	i++
	SetValueForField(doc, "STAT", "OBS_THRESH", i, dataLen, fields, 20)
	i++
	SetValueForField(doc, "STAT", "COV_THRESH", i, dataLen, fields, 21)
	i++
	SetValueForField(doc, "STAT", "ALPHA", i, dataLen, fields, 22)
	i++
	SetValueForField(doc, "STAT", "LINE_TYPE", i, dataLen, fields, 23)
}
...
func (s *MODE_OBJ) fill_MODE_OBJ_Header(fields []string, doc *map[string]interface{}) {
	...
	// fill the met fields leaving out "" and NA values
	i++
	SetValueForField(doc, "MODE", "VERSION", i, dataLen, fields, 0)
	i++
	SetValueForField(doc, "MODE", "MODEL", i, dataLen, fields, 1)
	i++
	SetValueForField(doc, "MODE", "N_VALID", i, dataLen, fields, 2)
	i++
	SetValueForField(doc, "MODE", "GRID_RES", i, dataLen, fields, 3)
	i++
	SetValueForField(doc, "MODE", "DESC", i, dataLen, fields, 4)
	i++
	SetValueForField(doc, "MODE", "FCST_VALID", i, dataLen, fields, 6)
	i++
	SetValueForField(doc, "MODE", "FCST_ACCUM", i, dataLen, fields, 7)
	i++
	SetValueForField(doc, "MODE", "OBS_LEAD", i, dataLen, fields, 8)
	i++
	SetValueForField(doc, "MODE", "OBS_VALID", i, dataLen, fields, 9)
	i++
	SetValueForField(doc, "MODE", "OBS_ACCUM", i, dataLen, fields, 10)
	i++
	SetValueForField(doc, "MODE", "FCST_RAD", i, dataLen, fields, 11)
	i++
	SetValueForField(doc, "MODE", "FCST_THR", i, dataLen, fields, 12)
	i++
	SetValueForField(doc, "MODE", "OBS_RAD", i, dataLen, fields, 13)
	i++
	SetValueForField(doc, "MODE", "OBS_THR", i, dataLen, fields, 14)
	i++
	SetValueForField(doc, "MODE", "FCST_VAR", i, dataLen, fields, 15)
	i++
	SetValueForField(doc, "MODE", "FCST_UNITS", i, dataLen, fields, 16)
	i++
	SetValueForField(doc, "MODE", "OBS_VAR", i, dataLen, fields, 18)
	i++
	SetValueForField(doc, "MODE", "OBS_UNITS", i, dataLen, fields, 19)
	i++
	SetValueForField(doc, "MODE", "OBS_LEV", i, dataLen, fields, 20)
	i++
	SetValueForField(doc, "MODE", "OBTYPE", i, dataLen, fields, 21)
...
func (s *MTD_2DSINGLE) fill_MTD_2DSINGLE_Header(fields []string, doc *map[string]interface{}) {
	...
	// fill the met fields leaving out "" and NA values
	i++
	SetValueForField(doc, "MTD", "VERSION", i, dataLen, fields, 0)
	i++
	SetValueForField(doc, "MTD", "MODEL", i, dataLen, fields, 1)
	i++
	SetValueForField(doc, "MTD", "DESC", i, dataLen, fields, 2)
	i++
	SetValueForField(doc, "MTD", "FCST_VALID", i, dataLen, fields, 4)
	i++
	SetValueForField(doc, "MTD", "OBS_LEAD", i, dataLen, fields, 5)
	i++
	SetValueForField(doc, "MTD", "OBS_VALID", i, dataLen, fields, 6)
	i++
	SetValueForField(doc, "MTD", "T_DELTA", i, dataLen, fields, 7)
	i++
	SetValueForField(doc, "MTD", "FCST_T_BEG", i, dataLen, fields, 8)
	i++
	SetValueForField(doc, "MTD", "FCST_T_END", i, dataLen, fields, 9)
	i++
	SetValueForField(doc, "MTD", "FCST_RAD", i, dataLen, fields, 10)
	i++
	SetValueForField(doc, "MTD", "FCST_THR", i, dataLen, fields, 11)
	i++
	SetValueForField(doc, "MTD", "OBS_T_BEG", i, dataLen, fields, 12)
	i++
	SetValueForField(doc, "MTD", "OBS_T_END", i, dataLen, fields, 13)
	i++
	SetValueForField(doc, "MTD", "OBS_RAD", i, dataLen, fields, 14)
	i++
	SetValueForField(doc, "MTD", "OBS_THR", i, dataLen, fields, 15)
	i++
	SetValueForField(doc, "MTD", "FCST_VAR", i, dataLen, fields, 16)
	i++
	SetValueForField(doc, "MTD", "FCST_UNITS", i, dataLen, fields, 17)
	i++
	SetValueForField(doc, "MTD", "OBS_VAR", i, dataLen, fields, 19)
	i++
	SetValueForField(doc, "MTD", "OBS_UNITS", i, dataLen, fields, 20)
	i++
	SetValueForField(doc, "MTD", "OBS_LEV", i, dataLen, fields, 21)
