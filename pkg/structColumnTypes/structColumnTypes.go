...
func (s *STAT_SSIDX) fill_STAT_SSIDX_Header(fields []string, doc *map[string]interface{}) {
	...
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["VERSION"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["MODEL"] = fields[i]
	...
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_VALID_BEG"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_VALID_END"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_LEAD"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_VALID_BEG"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_VALID_END"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_VAR"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_UNITS"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_LEV"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_VAR"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_UNITS"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_LEV"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBTYPE"] = fields[i]
	...
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["VX_MASK"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["INTERP_MTHD"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["INTERP_PNTS"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_THRESH"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_THRESH"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["COV_THRESH"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["ALPHA"] = fields[i]
...
func (s *MODE_OBJ) fill_MODE_OBJ_Header(fields []string, doc *map[string]interface{}) {
	...
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["N_VALID"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["GRID_RES"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["DESC"] = fields[i]
	...
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_VALID"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_ACCUM"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_LEAD"] = fields[i]
	...
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_VALID"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_ACCUM"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_RAD"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_THR"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_RAD"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_THR"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_VAR"] = fields[i]
...
func (s *TCST_TCDIAG) fill_TCST_TCDIAG_Header(fields []string, doc *map[string]interface{}) {
	...
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["CYCLONE"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["STORM_NAME"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["INIT"] = fields[i]
	...
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["INIT_MASK"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["VALID_MASK"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["LINE_TYPE"] = fields[i]
...
func (s *MTD_3DSINGLE) fill_MTD_3DSINGLE_Header(fields []string, doc *map[string]interface{}) {
	...
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["T_DELTA"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_T_BEG"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_T_END"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["FCST_RAD"] = fields[i]
	...
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_T_BEG"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_T_END"] = fields[i]
	}
	i++
	if i <= dataLen && fields[i] != "" && fields[i] != "NA" {
		(*doc)["OBS_RAD"] = fields[i]
